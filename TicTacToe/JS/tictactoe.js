...
//The .some() method is used to check each elemend of selectedSquare array to
//see if it contains the square number clicked on.
  ...
  //drawWinLine function is called to draw line if condition is met.
    function checkWinConditions () {
      ...
      //This condition checks for tie. If non of the aboce conditions register
...
//This function interacts with the canvas
    function animateLineDrawing() {
      ...
      //This smethod clears content from last loop iteration.
      ...
      //This condition checks if we've reached the endpoint/
        if (x1 <= x2 && y1 <= y2) {
          ...
          //It was necessary tfor the 6, 4, 2 win condition.
            if (x1 <= x2 && y1 >= y2) {
                if (x < x2) { x += 10; }
                if (y > y2) { y -= 10; }
                if (x >= x2 && y <= y2) { cancelAnimationFrame(animationLoop); }
